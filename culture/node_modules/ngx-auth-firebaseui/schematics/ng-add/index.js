...
function addPackageJsonDependencies() {
    return (host, context) => {
        ...
        const dependencies = [
            { type: helpers_1.NodeDependencyType.Default, version: loadPackageVersionGracefully() || '3.2.3', name: 'ngx-auth-firebaseui' },
            { type: helpers_1.NodeDependencyType.Default, version: ngCoreVersionTag || '8.1.1', name: '@angular/animations' },
            { type: helpers_1.NodeDependencyType.Default, version: ngCoreVersionTag || '8.1.1', name: '@angular/forms' },
            { type: helpers_1.NodeDependencyType.Default, version: ngCoreVersionTag || '8.1.1', name: '@angular/router' },
            { type: helpers_1.NodeDependencyType.Default, version: '^8.0.0-beta.26', name: '@angular/flex-layout' },
            { type: helpers_1.NodeDependencyType.Default, version: '^5.2.1', name: '@angular/fire' },
            { type: helpers_1.NodeDependencyType.Default, version: '^6.3.40', name: 'firebase' }
        ];
